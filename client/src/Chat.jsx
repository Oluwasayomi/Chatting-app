        ...
        <div className="flex h-screen">
            <div className="bg-amber-400 w-1/3 pl-2 pt-4">
                ...
                {Object.keys(onlinePeople).map(userId => (
                    <div onClick={() => setSelectedUserId(userId)} key={userId} className={"border-b border-green-200 py-2 flex items items-center gap-2 cursor-pointer " +(userId === selectedUserId ? 'bg-green-400' : '')}>
