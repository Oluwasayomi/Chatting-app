...
export default function Chat() {
    ...
    return (
        <div className="flex h-screen">
            <div className="bg-amber-400 w-1/3 flex flex-col">
                ...
                <div className="p-2 text-center flex items-center justify-center">
                    ...
                    <button 
                    onClick={logout}
                    className="text-sm bg-green-400 py-1 px-2 text-gray-700 border border-amber-500 rounded-sm">
                        Logout
                    </button>
                </div>
            </div>
                                ...
                                {messagesWithoutDupes.map(message => (
                                    <div className= {(message.sender === id? 'text-right': 'text-left')}>
                                        <div className={"text-left inline-block p-2 my-2 rounded-md text-sm " + (message.sender === id? 'bg-green-500 text-white': 'bg-amber-100 text-gray-500')}> 
                                            ...
                                            {message.file && (
                                                <div>
                                                    <a className="flex items-center gap-1 border-b" href={axios.defaults.baseURL + '/' + message.file}>
